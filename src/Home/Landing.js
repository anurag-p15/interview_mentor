...
function Landing() {
    ...
    return(
        ...
        <div className="container1">
            <div className="left1">
                <div><button onClick={()=>navigate('/form')} className='i-button'>
                    <p>Give Interview</p></button>
                </div>
                <div className='left1-text'>
                    ...
                    <div><button onClick={()=> navigate('/register')} className='platform'>
                    <span><p style={{paddingLeft:'40px'}}>Join our Platform  &rarr;  </p></span></button>    
                    </div>
                </div>        
            </div>
            <div className="right1">
                <div>
                    <span ><button onClick={() => navigate('/login')} className='login-button'>
                        <p>Login</p></button>
                    </span>
                    <span><button onClick={()=> navigate('/dashboard')} className='d-button'>
...
With regular updates, you'll be fully equipped for any interview, as we continuously incorporate the newest trends and technologies into our quizzes.                  </p>
                  </div>
            </div>
        </div>
